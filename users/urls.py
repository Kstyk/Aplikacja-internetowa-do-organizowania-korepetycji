...
from .views import UserRegistrationView, RolesListView, UsersListView, TeachersListView, UserDetailsCreateView, UserDetailsUpdateView, UserProfileView, UserUpdateView, VoivodeshipListView, CityListView, get_top_cities, CityByIdView, BaseUserView, ChangePasswordView, LoggeUserProfileView
urlpatterns = [
