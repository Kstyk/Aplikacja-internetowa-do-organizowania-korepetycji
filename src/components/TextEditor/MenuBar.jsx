...
const MenuBar = ({ editorComponent }) => {
  ...
  return (
    <div className="w-full flex flex-row flex-wrap justify-start">
      ...
      >
        <LuHeading1 className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
      ...
      >
        <LuHeading2 className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
      ...
      >
        <LuHeading3 className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
        data-tip="Paragraf"
      ...
      >
        <BsTextParagraph className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
      ...
      >
        <LuBold className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
        data-tip="Kursywa"
      ...
      >
        <LuItalic className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
      ...
      >
        <LuUnderline className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
      ...
      >
        <LuStrikethrough className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
      ...
      >
        <LuSuperscript className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
      ...
      >
        <LuSubscript className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
        data-tip="Link"
      ...
      >
        <LuLink className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
      ...
      >
        <AiOutlineUnorderedList className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
      ...
      >
        {" "}
        <AiOutlineOrderedList className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
      ...
      >
        <LuAlignLeft className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
      ...
      >
        <LuAlignCenter className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
      ...
      >
        <LuAlignRight className="font-bold w-4 h-4" />
      </button>
      <button
        type="button"
      ...
      >
        <LuAlignJustify className="font-bold w-4 h-4" />
      </button>
    </div>
  );
};
