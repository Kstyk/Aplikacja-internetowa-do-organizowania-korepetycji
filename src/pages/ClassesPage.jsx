...
const ClassesPage = () => {
    ...
    const fetchOpinions = async () => {
        await api
            .get(
                `/api/classes/${classes?.teacher?.user?.id}/opinions?page_size=10`
            )
            .then((res) => {
                setLoading(false)
    ...
    return (
        <>
            {loading ? (
                ...
                <section className="mb-10 mt-10 w-full max-md:px-3 max-phone:px-0">
