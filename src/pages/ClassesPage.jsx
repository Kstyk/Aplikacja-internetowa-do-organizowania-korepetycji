...
const ClassesPage = () => {
  ...
  return (
    <section className="mt-10 w-full max-phone:px-3 mb-10">
      ...
      <h1 className="md:text-2xl max-md:text-xl max-phone:text-lg card bg-white rounded-none mb-5 text-center p-4 border-[1px] border-base-200">
        {classes?.name}
      </h1>
      <div className="flex md:flex-row md:gap-x-2 max-md:flex-col">
        <div className="card border-[1px] border-base-200 py-4 rounded-none bg-white md:w-9/12 max-md:w-full flex phone:flex-row max-phone:flex-col ">
          <div className="profile  ml-3 pr-3 w-4/12 max-phone:w-full border-r-[1px] border-base-300 flex flex-col justify-center items-center max-phone:order-2">
            ...
            <section className="infos flex flex-col w-full pt-4">
              ...
              {classes?.teacher?.place_of_classes && (
                <>
                  ...
                  <h3 className="text-sm mb-1">Sposób prowadzenia zajęć:</h3>
                  <ul className="w-full">
              ...
              <ul className="w-full">
                {classes?.teacher?.cities_of_work.map((city, i) => (
                  <li key={i} className="flex flex-row items-center gap-x-5">
                    <MdOutlineLocationOn className="w-6 h-6 text-base-400" />
